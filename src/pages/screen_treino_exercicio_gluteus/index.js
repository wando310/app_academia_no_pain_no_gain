...
import arrayTreining from "./arrayTreiningGluteus";

import * as Anima from 'react-native-animatable';

const Screen_treino_exercicio_gluteus = ({ navigation }) => {

    function exercicio(e) { navigation.navigate('exercicios', { dados: arrayTreining[e], back:'treino_exercicio_gluteus' }) }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.container_shadow}>
                ...
                <View style={styles.container_exercicios} >
                    <Anima.Text animation='bounceIn' duration={4000} style={styles.title}>Exercícios para Glúteus</Anima.Text>
                    ...
                    <TouchableOpacity onPress={() => exercicio(8)}>
                        <Anima.Text  animation='bounceInLeft'delay={800} style={styles.exercicio}>8 - { arrayTreining[8].title }</Anima.Text>
                    </TouchableOpacity>                   
                </View>
            </View>
        </SafeAreaView>
...
export default Screen_treino_exercicio_gluteus;
