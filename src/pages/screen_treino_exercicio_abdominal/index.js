...
import arrayTreining from "./arrayTreiningAbdominal";

import * as Anima from 'react-native-animatable';

const Screen_treino_exercicio_abdominal = ({ navigation }) => {

    function exercicio(e) { navigation.navigate('exercicios', { dados: arrayTreining[e], back:'treino_exercicio_abdominal' }) }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.container_shadow}>
                ...
                <ScrollView style={styles.container_exercicios} >
                    <Anima.Text animation='bounceIn' duration={4000} style={styles.title}>Exercícios para Abdominais</Anima.Text>
                    <TouchableOpacity onPress={() => exercicio(0)}>
                        <Anima.Text  animation='bounceInLeft'delay={0} style={styles.exercicio}>1 - { arrayTreining[0].title }</Anima.Text>
                    </TouchableOpacity>
...
export default Screen_treino_exercicio_abdominal;
