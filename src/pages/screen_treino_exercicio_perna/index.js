...
import arrayTreining from "./arrayTreiningPerna";

import * as Anima from 'react-native-animatable';

const Screen_treino_exercicio_perna = ({ navigation }) => {

    function exercicio(e) { navigation.navigate('exercicios', { dados: arrayTreining[e], back:'treino_exercicio_perna' }) }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.container_shadow}>
                ...
                <ScrollView style={styles.container_exercicios} >
                    <Anima.Text animation='bounceIn' duration={4000} style={styles.title}>Exercícios para Pernas</Anima.Text>
                    ...
                    <TouchableOpacity onPress={() => exercicio(15)}>
                        <Anima.Text  animation='bounceInLeft'delay={1500} style={styles.exercicio}>16 - { arrayTreining[15].title }</Anima.Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => exercicio(16)}>
                        <Anima.Text  animation='bounceInLeft'delay={1600} style={styles.exercicio}>17 - { arrayTreining[16].title }</Anima.Text>
                    </TouchableOpacity>
                </ScrollView>
            </View>
        </SafeAreaView>
...
export default Screen_treino_exercicio_perna;
